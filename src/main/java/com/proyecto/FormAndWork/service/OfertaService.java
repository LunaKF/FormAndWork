...
public class OfertaService implements ServiceInterface<OfertaEntity> {
    ...
    {
        ofertasEmpleo.put("Administración y gestión", new String[]{"Asistente administrativo", "Contable", "Secretario/a"});
        ofertasEmpleo.put("Agraria", new String[]{"Agricultor/a", "Ganadero/a", "Técnico agrícola"});
        ofertasEmpleo.put("Artes gráficas", new String[]{"Diseñador gráfico", "Impresor/a", "Técnico de preimpresión"});
        ofertasEmpleo.put("Artes y artesanías", new String[]{"Artista plástico", "Artesano/a", "Diseñador de joyas"});
        ofertasEmpleo.put("Comercio y marketing", new String[]{"Vendedor/a", "Gestor de marketing", "Community Manager"});
        ofertasEmpleo.put("Electricidad y electrónica", new String[]{"Técnico electricista", "Ingeniero electrónico", "Operador de sistemas"});
        ofertasEmpleo.put("Energía y agua", new String[]{"Técnico de energía solar", "Ingeniero de energía eólica", "Operador de planta"});
        ofertasEmpleo.put("Fabricación mecánica", new String[]{"Técnico de mantenimiento", "Ingeniero mecánico", "Operador de maquinaria"});
        ...
        ofertasEmpleo.put("Informática y comunicaciones", new String[]{"Desarrollador Java", "Analista de datos", "Técnico en redes"});
        ofertasEmpleo.put("Instalación y mantenimiento", new String[]{"Técnico de climatización", "Instalador de sistemas de seguridad", "Mecánico de electrodomésticos"});
        ofertasEmpleo.put("Madera, mueble y corcho", new String[]{"Carpintero/a", "Diseñador de interiores", "Ebanista"});
        ofertasEmpleo.put("Marítimo-pesquera", new String[]{"Pescador/a", "Técnico de acuicultura", "Capitán de barco"});
        ofertasEmpleo.put("Química", new String[]{"Técnico de laboratorio", "Químico/a analista", "Investigador/a químico"});
        ofertasEmpleo.put("Sanidad", new String[]{"Enfermero/a", "Médico general", "Técnico de laboratorio"});
        ofertasEmpleo.put("Seguridad y medio ambiente", new String[]{"Técnico de seguridad", "Inspector ambiental", "Gestor de residuos"});
        ofertasEmpleo.put("Servicios socioculturales y a la comunidad", new String[]{"Educador/a social", "Trabajador/a social", "Psicólogo/a"});
        ofertasEmpleo.put("Textil, confección y piel", new String[]{"Diseñador de moda", "Sastre/a", "Operador de máquina de coser"});
        ofertasEmpleo.put("Transporte y mantenimiento de vehículos", new String[]{"Conductor de camión", "Mecánico de automóviles", "Técnico de logística"});
        ofertasEmpleo.put("Vidrio y cerámica", new String[]{"Cristalero/a", "Ceramista", "Técnico de calidad en vidrio"});
    }
    ...
    public Long randomCreate(Long cantidad) {
        ...
        String titulo = ofertasEmpleo.get(sectorClave)[oRandomService.getRandomInt(0, ofertasEmpleo.get(sectorClave).length - 1)];
    ...
    public Page<OfertaEntity> getPage(Pageable oPageable, Optional<String> filter) {
        if (filter.isPresent()) {
            return oOfertaRepository.findByTituloContainingOrDescripcionContainingOrEmpresa_NombreContainingOrSector_NombreContaining(
